  ...
  return (
    <section className="flex justify-center mx-5">
      <div className="flex gap-1 justify-center bg-blue rounded-xl">
        <div className="rounded-l-xl flex flex-col md:flex-row gap-2.5 px-3 py-2 md:px-6 md:py-4 hover:bg-green items-center duration-300 ease-linear cursor-pointer text-white">
