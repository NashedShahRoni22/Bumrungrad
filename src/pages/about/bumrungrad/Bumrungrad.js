      ...
      <div className='mx-5 my-20'>
        ...
        <div className='mt-4'>
          <p className='text-justify mt-5'>
            ...
            Bumrungrad has expanded the Precision Medicine department which
            ...
            leader in cutting-edge technology, Bumrungrad was the first IBM
      ...
      <div className='mx-5 my-20'>
        ...
        <div className='mt-4'>
          <p className='text-justify mt-5'>
            ...
            medical tourism hospital destinations. Nearly all Bumrungrad doctors
            ...
            arrival through our Bumrungrad International Airport Representative
            Office at Suvarnabhumi Airport. Convenience plays another vital role
            at Bumrungrad and the hospital’s one-stop medical campus is able to
            ...
            need and return home sooner. Bumrungrad International Hospital also
            ...
            coordination, Bumrungrad goes the extra mile to ensure that every
            patient is treated equal and with care, no matter where they are
            from. That’s why the Thai name Bumrungrad means “care for the
            people.”
          </p>
          <div className='ml-4 mt-4'>
