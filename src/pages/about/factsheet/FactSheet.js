...
import buildingimg from "../../../assets/about_bumrungrad/FactSheet/Main Hospital Facility & services.png";
import clinicimg from "../../../assets/about_bumrungrad/FactSheet/Outpatient Clinic Facility & Services.png";
import resourceimg from "../../../assets/about_bumrungrad/FactSheet/Human Resources.png";
import roomimg from "../../../assets/about_bumrungrad/FactSheet/Outpatient Facilities.png";
import bumrunCenterimg from "../../../assets/about_bumrungrad/FactSheet/Outpatient Clinics, Centers and Programs.png";
import techimg from "../../../assets/about_bumrungrad/FactSheet/International Referral Offices.png";
import internimg from "../../../assets/about_bumrungrad/FactSheet/Quality, Accreditations, Certifications and Recognitions.png";
import responimg from "../../../assets/about_bumrungrad/FactSheet/Social Responsibility.png";
      ...
      <div className="mx-5 my-10">
        <div className="my-10">
          ...
          <p className="text-[16px] py-3 text-blue font-medium">
            ...
            <Link
              className="text-blue font-semibold underline"
              to="https://bumrungraddiscover.com/our_services"
            >
              Services
            </Link>{" "}
        ...
        <ol className="pl-6 list-decimal">
          ...
          <li className=" mt-2">E-mail <Link to="https://bumrungraddiscover.com/contact_us" className="text-blue font-semibold underline">contact</Link> center,</li>
          <li className=" mt-2">
